...
<div class="wrapper">
    ...
    <nav class="top-bar animate-dropdown">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <ul>
                    <li><a href="http://localhost/~ibrahim/themeforest/HTML/mediacenter/upload/PHP/index.php?page=home">Home</a></li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="index.php?page=home&amp;style=alt">Home</a></li>
                            <li><a href="index.php?page=home-2&amp;style=alt">Home Alt</a></li>
                            <li><a href="index.php?page=category-grid&amp;style=alt">Category - Grid/List</a></li>
                            <li><a href="index.php?page=category-grid-2&amp;style=alt">Category 2 - Grid/List</a></li>
                            <li><a href="index.php?page=single-product&amp;style=alt">Single Product</a></li>
                            <li><a href="index.php?page=single-product-sidebar&amp;style=alt">Single Product with Sidebar</a></li>
                            <li><a href="index.php?page=cart&amp;style=alt">Shopping Cart</a></li>
                            <li><a href="checkout.html&amp;style=alt">Checkout</a></li>
                            <li><a href="index.php?page=about&amp;style=alt">About Us</a></li>
                            <li><a href="index.php?page=contact&amp;style=alt">Contact Us</a></li>
                            <li><a href="index.php?page=blog&amp;style=alt">Blog</a></li>
                            <li><a href="index.php?page=blog-fullwidth&amp;style=alt">Blog Full Width</a></li>
                            <li><a href="index.php?page=blog-post&amp;style=alt">Blog Post</a></li>
                            <li><a href="index.php?page=faq&amp;style=alt">FAQ</a></li>
                            <li><a href="index.php?page=terms&amp;style=alt">Terms & Conditions</a></li>
                            <li><a href="index.php?page=authentication&amp;style=alt">Login/Register</a></li>
                            <li><a href="index.php?page=404&amp;style=alt">404</a></li>
                            <li><a href="index.php?page=wishlist&amp;style=alt">Wishlist</a></li>
                            <li><a href="index.php?page=compare&amp;style=alt">Product Comparison</a></li>
                            <li><a href="index.php?page=track-your-order&amp;style=alt">Track your Order</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.col -->
    ...
    <header class="no-padding-bottom header-alt">
        <div class="container no-padding">
            ...
            <div class="col-xs-12 col-md-3 logo-holder">
                <!-- ============================================================= LOGO ============================================================= -->
                <div class="logo">
                    <a href="http://localhost/~ibrahim/themeforest/HTML/mediacenter/upload/PHP/index.php?page=home">
    ...
    <!-- ============================================================= HEADER : END ============================================================= -->		<div class="main-content" id="main-content">
    <div class="row">
            ...
            <div class="items-holder">
                <div class="container-fluid wishlist_table">
                    ...
                    <div class="row cart-item cart_item" id="yith-wcwl-row-1">
                        ...
                        <div class="col-xs-12 col-sm-1 no-margin">
                            <a href="index.php?page=single-product">
                                <img width="73" height="73" alt="Canon PowerShot Elph 115 IS" class="attachment-shop_thumbnail wp-post-image" src="<c:url value="/resources/assets/images/products/product-small-03.jpg"/>">
                            </a>
                        </div>
                    ...
                    <div class="row cart-item cart_item" id="yith-wcwl-row-6">
                        ...
                        <div class="col-xs-12 col-sm-1 no-margin">
                            <a href="index.php?page=single-product">
                                <img width="73" height="73" alt="I - Book Mini Laptop" class="attachment-shop_thumbnail wp-post-image" src="<c:url value="/resources/assets/images/products/product-small-02.jpg"/>">
                            </a>
                        </div>
                        <div class="col-xs-12 col-sm-4 no-margin">
                            <div class="title">
...
<div class="config open">
    <div class="config-options">
        ...
        <ul class="list-unstyled">
            <li><a href="index.php?page=wishlist&amp;style=alt&amp;style=alt1">Header 1</a></li>
            <li><a href="index.php?page=wishlist&amp;style=alt&amp;style=alt">Header 2</a></li>
        </ul>
        <h4>Colors</h4>
        <ul class="list-unstyled">
