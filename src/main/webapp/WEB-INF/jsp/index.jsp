...
<head>
    ...
    <link rel="alternate stylesheet" href="<c:url value="/resources/assets/css/green.css"/>" title="Green color">
    <link rel="alternate stylesheet" href="<c:url value="/resources/assets/css/blue.css"/>" title="Blue color">
    <link rel="alternate stylesheet" href="<c:url value="/resources/assets/css/red.css"/>" title="Red color">
    <link rel="alternate stylesheet" href="<c:url value="/resources/assets/css/orange.css"/>" title="Orange color">
    <link rel="alternate stylesheet" href="<c:url value="/resources/assets/css/navy.css"/>" title="Navy color">
    <link rel="alternate stylesheet" href="<c:url value="/resources/assets/css/dark-green.css"/>" title="Darkgreen color">
                                    ...
                                    <div class="basket-item">
                                        <div class="row">
                                            <div class="col-xs-4 col-sm-4 no-margin text-center">
                                                <div class="thumb">
                                                    <img alt="" src="<c:url value="/resources/assets/images/products/product-small-01.jpg"/>" />
                                                </div>
                                            </div>
                                ...
                                <li class="yamm-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="dropdown-banner-holder">
                                            <a href="#"><img alt="" src="<c:url value="/resources/assets/images/banners/banner-side.png"/>" /></a>
                                        </div>
                                    </div>
                                    <!-- ================================== MEGAMENU VERTICAL ================================== -->
                                </li>
        ...
        <div class="col-xs-12 col-sm-8 col-md-9 homebanner-holder">
            ...
            <div id="hero">
                <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                    ...
                    <div class="item" style="background-image: url(<c:url value="/resources/assets/images/sliders/slider01.jpg"/>);">
        ...
        <div class="container">
            <div class="col-xs-12 col-lg-6 no-margin banner">
                <a href="category-grid-2.html">
                    ...
                    <img class="banner-image" alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/banners/banner-narrow-01.jpg"/>" />
                </a>
            </div>
            <div class="col-xs-12 col-lg-6 no-margin text-right banner">
                <a href="category-grid-2.html">
                    ...
                    <img class="banner-image" alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/banners/banner-narrow-02.jpg"/>" />
                </a>
            </div>
        </div><!-- /.container -->
                        ...
                        <div class="product-grid-holder">
                            <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <div class="image">
                                        <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-01.jpg"/>" />
                                    </div>
                                    <div class="body">
                            ...
                            <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <div class="image">
                                        <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-02.jpg"/>" />
                                    </div>
                                    <div class="body">
                            ...
                            <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <div class="image">
                                        <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-03.jpg"/>" />
                                    </div>
                                    <div class="body">
                                        <div class="label-discount clear"></div>
                                        <div class="title">
                            ...
                            <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <div class="image">
                                        <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="assets/images/products/product-04.jpg" />
                                    </div>
                                    <div class="body">
                                        <div class="label-discount clear"></div>
                                        <div class="title">
                        ...
                        <div class="product-grid-holder">
                            ...
                            <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                                <div class="product-item">
                                    <div class="ribbon blue"><span>new!</span></div>
                                    <div class="image">
                                        <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="assets/images/products/product-02.jpg" />
                                    </div>
                                    <div class="body">
                                        <div class="label-discount clear"></div>
                                        <div class="title">
                            ...
                            <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                                <div class="product-item">
                                    <div class="ribbon red"><span>sale</span></div>
                                    <div class="image">
                                        <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="assets/images/products/product-01.jpg" />
                                    </div>
                                    <div class="body">
                                        <div class="label-discount green">-50% sale</div>
                                        <div class="title">
                            ...
                            <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <div class="image">
                                        <img alt="" src="<c:url value ="resources/assets/images/blank.gif "/>" data-echo="assets/images/products/product-03.jpg" />
                                    </div>
                                    <div class="body">
                                        <div class="label-discount clear"></div>
                                        <div class="title">
                ...
                <div class="col-xs-12 col-md-7 no-margin">
                    ...
                    <div class="row no-margin">
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                            <div class="product-item">
                                <div class="image">
                                    <img alt="" src="<c:url value = "/resources/assets/images/blank.gif"/>" data-echo="assets/images/products/product-05.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                            <div class="product-item">
                                <div class="image">
                                    <img alt="" src="<c:url value = "/resources/assets/images/blank.gif"/>" data-echo="assets/images/products/product-06.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                            <div class="product-item">
                                <div class="image">
                                    <img alt="" src="<c:url value = "/resources/assets/images/blank.gif"/>" data-echo="assets/images/products/product-07.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                    ...
                    <div class="row no-margin">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                            <div class="product-item">
                                <div class="image">
                                    <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="assets/images/products/product-09.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                ...
                <div class="col-xs-12 col-md-5 no-margin">
                    <div class="product-item-holder size-big single-product-gallery small-gallery">
                        ...
                        <div class="gallery-thumbs clearfix">
                            <ul>
                                <li><a class="horizontal-thumb active" data-target="#best-seller-single-product-slider" data-slide="0" href="#slide1"><img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="assets/images/products/gallery-thumb-01.jpg" /></a></li>
                                <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="1" href="#slide2"><img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="assets/images/products/gallery-thumb-01.jpg" /></a></li>
                                <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="2" href="#slide3"><img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="assets/images/products/gallery-thumb-01.jpg" /></a></li>
                            </ul>
                        </div><!-- /.gallery-thumbs -->
                ...
                <div id="owl-recently-viewed" class="owl-carousel product-grid-holder">
                    <div class="no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            <div class="ribbon red"><span>sale</span></div>
                            <div class="image">
                                <img alt="" src="<c:url value = "/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-11.jpg"/>"  />
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class="no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            <div class="ribbon blue"><span>new!</span></div>
                            <div class="image">
                                <img alt="" src="<c:url value = "/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-12.jpg"/>" />
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class=" no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            ...
                            <div class="image">
                                <img alt="" src="<c:url value = "/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-13.jpg"/>" />
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class=" no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            <div class="ribbon blue"><span>new!</span></div>
                            <div class="image">
                                <img alt="" src="<c:url value = "/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-14.jpg"/>" />
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class=" no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            <div class="ribbon green"><span>bestseller</span></div>
                            <div class="image">
                                <img alt="" src="<c:url value = "/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-15.jpg"/>" />
                            </div>
                            <div class="body">
                                <div class="title">
                    ...
                    <div class=" no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            ...
                            <div class="image">
                                <img alt="" src="<c:url value = "/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-16.jpg"/>" />
                            </div>
                            <div class="body">
                                <div class="title">
                            ...
                            <ul>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-small-01.jpg"/>" />
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-small-02.jpg"/>" />
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-small-03.jpg"/>" />
                                            </a>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <ul>
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-small-04.jpg"/>" />
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-small-05.jpg"/>" />
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-small-06.jpg"/>" />
                                            </a>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <ul>
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-small-07.jpg"/>" />
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-small-08.jpg"/>" />
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="<c:url value="/resources/assets/images/blank.gif"/>" data-echo="<c:url value="/resources/assets/images/products/product-small-09.jpg"/>" />
                                            </a>
                                        </div>
            ...
            <div class="container">
                ...
                <div class="col-xs-12 col-sm-6 no-margin">
                    <div class="payment-methods ">
                        <ul>
                            <li><img alt="" src="<c:url value="/resources/assets/images/payments/payment-visa.png"/>"></li>
                            <li><img alt="" src="<c:url value="/resources/assets/images/payments/payment-master.png"/>"></li>
                            <li><img alt="" src="<c:url value="/resources/assets/images/payments/payment-paypal.png"/>"></li>
                            <li><img alt="" src="<c:url value="/resources/assets/images/payments/payment-skrill.png"/>"></li>
                        </ul>
                    </div><!-- /.payment-methods -->
                </div>
            </div><!-- /.container -->
