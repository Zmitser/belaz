    ...
    <nav class="top-bar animate-dropdown">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <ul>
                    <li><a href="http://localhost/~akther/themeforest/mediacenter/upload/PHP/index.html">Home</a></li>
                    <li class="dropdown">
    ...
    <header>
        <div class="container no-padding">
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                <!-- ============================================================= LOGO ============================================================= -->
                <div class="logo">
                    <a href="http://localhost/~akther/themeforest/mediacenter/upload/PHP/index.html">
