...
public class DumpTruckCrossCountryCapacityPdfBuilder extends AbstractITextPdfView {
    ...
    protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        DumpTrucksCrossCountryCapacity dumpTrucksCrossCountryCapacity = (DumpTrucksCrossCountryCapacity) model.get("dumpTrucksCrossCountryCapacity");
        ...
        Image logo  = Image.getInstance(savePath + "\\resources\\assets\\images\\Belaz_logo.png");
        ...
        Paragraph coverTitle = new Paragraph(dumpTrucksCrossCountryCapacity.getModel().getName(), FontFactory.getFont(
        ...
        Paragraph element = new Paragraph(dumpTrucksCrossCountryCapacity.getModel().getName(), FontFactory.getFont(
        ...
        Paragraph sectionText = new Paragraph(dumpTrucksCrossCountryCapacity.getApplication());
        sectionText.setSpacingAfter(10);
        sectionText.setSpacingBefore(10);
        section.add(sectionText);
        Image image1 = Image.getInstance(savePath + "/resources/assets/images/" + dumpTrucksCrossCountryCapacity.getPhotos().get(0).getName());
        ...
        Image image2 = Image.getInstance(savePath + "/resources/assets/images/" + dumpTrucksCrossCountryCapacity.getPhotos().get(1).getName());
        ...
        Image image3 = Image.getInstance(savePath + "/resources/assets/images/" + dumpTrucksCrossCountryCapacity.getPhotos().get(2).getName());
        ...
        Paragraph sectionText2 = new Paragraph(dumpTrucksCrossCountryCapacity.getAdvantages());
        ...
        Paragraph sectionText3 = new Paragraph(dumpTrucksCrossCountryCapacity.getCompleteSet());
        ...
        cell.setPhrase(new Phrase(dumpTrucksCrossCountryCapacity.getModel().getName(), font));
        table.addCell(cell);
        cell.setPhrase(new Phrase(dumpTrucksCrossCountryCapacity.getManufacturer().getName(), font));
        table.addCell(cell);
        cell.setPhrase(new Phrase(dumpTrucksCrossCountryCapacity.getManufacturerCountry().getName(), font));
        table.addCell(cell);
        cell.setPhrase(new Phrase(dumpTrucksCrossCountryCapacity.getMachineCondition().getName(), font));
        table.addCell(cell);
        cell.setPhrase(new Phrase(dumpTrucksCrossCountryCapacity.getMachineLocation().getName(), font));
        table.addCell(cell);
        cell.setPhrase(new Phrase(dumpTrucksCrossCountryCapacity.getEngine().getName(), font));
        table.addCell(cell);
