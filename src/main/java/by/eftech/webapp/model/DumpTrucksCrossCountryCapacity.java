...
@Entity
@Table(name = "dump_trucks_cross_country_capacity", schema = "belaz", catalog = "")
public class DumpTrucksCrossCountryCapacity {
    private Integer id;
    private String year;
    ...
    public boolean equals(Object o) {
        ...
        DumpTrucksCrossCountryCapacity that = (DumpTrucksCrossCountryCapacity) o;
        ...
        if (loadingHeight != null ? !loadingHeight.equals(that.loadingHeight) : that.loadingHeight != null)
            return false;
        if (frame != null ? !frame.equals(that.frame) : that.frame != null) return false;
        if (fordingDepth != null ? !fordingDepth.equals(that.fordingDepth) : that.fordingDepth != null) return false;
        if (climableSlopes != null ? !climableSlopes.equals(that.climableSlopes) : that.climableSlopes != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (loadingHeight != null ? loadingHeight.hashCode() : 0);
        result = 31 * result + (frame != null ? frame.hashCode() : 0);
        result = 31 * result + (fordingDepth != null ? fordingDepth.hashCode() : 0);
        result = 31 * result + (climableSlopes != null ? climableSlopes.hashCode() : 0);
        return result;
    }
    ...
    @OneToOne(mappedBy = "dumpTrucksCrossCountryCapacity")
